...
class TestAlertsFrameWindow:
    ...
    class TestNestedFramesPage:
        def test_nested_frames(self, driver):
            ...
            assert child_text == 'Child Iframe', 'Child frame does not exist'
    ...
    class TestModalDialogsPage:
        def test_modal_dialogs(self, driver):
            ...
            assert small[1] < large[1], 'text from large dialog is less than small dialog'
            assert small[0] == 'Small Modal', 'The Small header is wrong'
            assert large[0] == 'Large Modal', 'The Large header is wrong'